                        ...
                        <form action="SvCrearTurno" method="POST">
                            <div class="mb-3">
                                <div class="form-floating">
                                    ...
                                    <input class="form-control" id="fecha" name="id" type="text" required pattern="^[0-9]+$" placeholder="Introduce el codigo del turno (Números) que creas conveniente. Algunos turnos pueden estar ya ocupados, se creativo con tu elección."/>
                                </div>
                            </div>
                            <div class="mb-3">
                                <div class="form-floating">
